  ...
  <div>
      ...
      <div class="cutting ajc">
        ...
        <div class="toggle">
          <h4
            ...
            :key="item.id"
            :class="{ underline: tabActiveIndex === index }"
    ...
    <div class="container">
      ...
      <div class="title-public">
        <img
          src="@/assets/img/index-img/19.png"
          alt=""
          class="image-public keywordsImage"
        />
      </div>
      <!-- 输入框 -->
      <div class="textarea">
      ...
      <div v-show="tabActiveIndex != 0">
        <div class="title-public">
          <img
            src="@/assets/img/index-img/20.png"
            alt=""
            class="image-public"
          />
        </div>
        <div class="fangao">
          ...
          >
            <div
              class="img-box"
              :class="{ gaofanactive: artistIndex === index }"
            >
      ...
      <div v-show="tabActiveIndex != 0">
        <div class="title-public">
          <img
            src="@/assets/img/index-img/21.png"
            alt=""
            class="image-public"
          />
        </div>
          ...
          >
            <div class="pain-img-box">
              <img
                ...
                class="pain-img"
                alt=""
                :class="{ activeimg: styleIndex === index }"
              />
            </div>
      ...
      <div class="title-public">
        <img
          src="@/assets/img/index-img/22.png"
          alt=""
          class="image-public special"
        />
      </div>
      <!-- 参考图片 -->
      ...
      <div class="proportion">
        <div
          class="proportion-s"
          v-for="(el, index) in ratio"
          :key="el.id"
          @click="changeratio(index, 'ratioIndex')"
        >
          <div class="proportion-s-box">
            <img
              :src="el.img"
              alt=""
              :class="{ borderpubs: ratioIndex === index }"
              class="img1"
              style="display: block"
            />
          </div>
      ...
      <div v-show="tabActiveIndex != 2">
        <div class="title-public">
          <img
            src="@/assets/img/index-img/24.png"
            alt=""
            class="image-public"
          />
        </div>
        ...
        <div class="props">
          ...
          <div class="slider-bottom-small-box">
            ...
            <div class="set-wrapper">
              <div
                class="btn-font-public btn10 ajc"
                v-for="(item, index) in expandSetList"
                :class="{ borderpubs: expandSetIndex === index }"
                :key="item.id"
          ...
          <!-- <div class="slider-bottom-small-footer-box">
            ...
            <div class="set-wrapper">
              <div
                class="btn-font-publics ajc"
                :class="{ borderpubs: setupSetIndex === index }"
                v-for="(item, index) in setupSetList"
                :key="item.id"
                @click="change(index, 'setupSetIndex')"
              >
                {{ item.text }}
              </div>
            </div>
    ...
    <div>
      ...
      <van-popup v-model="showTips" round :close-on-click-overlay="false">
        <div class="popup">
          <div class="pop-title">1个作品正在绘制</div>
          <div class="ajc">
        ...
        <div class="none-vip">
          ...
          <div class="none-vip-bottom-btn">
            ...
            <div
              ...
              :key="item.id"
              :class="{ btnInnerAvtive: btnInnerAvtive == item.id }"
    ...
    reDrawInfo: {
      handler: function (val) {
        if (Object.keys(val).length > 0) {
          ...
          const idx2 = this.promptActiveList.findIndex(
            (el) => el.value == val.TextPrompt
          );
